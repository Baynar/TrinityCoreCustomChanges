...
enum WorldBoolConfigs
{
    ...
    CONFIG_WORLD_CHAT_ENABLED,
    CONFIG_WORLD_CHAT_CROSSFACTION,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CHAT_STRICT_LINK_CHECKING_CUSTOM_LINKS,
    ...
    CONFIG_PLAYED_TIME_REWARD_INTERVAL,
    CONFIG_PLAYED_TIME_REWARD_MONEY,
    CONFIG_PLAYED_TIME_REWARD_VOTE,
    CONFIG_PLAYED_TIME_REWARD_DONOR,
