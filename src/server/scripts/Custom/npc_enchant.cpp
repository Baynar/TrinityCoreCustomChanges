...
void EnchantWithSpell(Player* player, uint32 spell_id, Item* item)
{
    ...
    //player->CastSpell(player, sSpellMgr->GetSpellInfo(spell_id), true);
}
...
void Enchant(Player* player, Creature* creature, Item* item, uint32 enchantid)
{
    ...
    switch (enchantid)
    {
        ...
        case ENCHANT_WEP_MASSACRE:
            ...
            {
                creature->Whisper("That isn't a two-handed weapon", LANG_UNIVERSAL, player);
                return;
            }
            break;
        ...
        case ENCHANT_SHIELD_TITANIUM_SPIKE:
            ...
            {
                creature->Whisper("That isn't a shield", LANG_UNIVERSAL, player);
                return;
            }
            break;
        ...
        case ENCHANT_RANGED_SUN_SCOPE:
            ...
            {
                creature->Whisper("That isn't a ranged weapon", LANG_UNIVERSAL, player);
                return;
            }
            break;
        default:
...
class npc_enchantment : public CreatureScript
{
    public:
        ...
        class npc_enchantmentAI : public ScriptedAI
        {
        public:
            ...
            void ShowMainMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_ShortBlade_02:24|t|r[Enchant Weapon]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_Staff_109:24|t|r[Enchant 2H Weapon]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_ShortBlade_02:24|t|r[Enchant Ranged Weapon]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Ability_Warrior_ShieldWall:24|t|r[Enchant Shield]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Head_Gnome_01:24|t|r[Enchant Head]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_SHOULDER_97:24|t|r[Enchant Shoulders]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Item_icecrowncloak:24|t|r[Enchant Cloak]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_ClothChest:24|t|r[Enchant Chest]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_MailBracer:24|t|r[Enchant Bracers]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_PlateGloves:24|t|r[Enchant Gloves]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
            ...
            void Show1HWeaponMenu(Player* player, Creature* creature)
            {
                ...
                if (player->getClass() == CLASS_DEATH_KNIGHT)
                {
                    ...
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Lichbane", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_LICHBANE);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Razorice", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_RAZORICE);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Spellbreaking", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_SPELLBREAKING);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Swordbreaking", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_SWORDBREAKING);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Fallen Crusader", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_FALLEN_CRUSADER);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Nerubian Carapace", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_NERUBIAN_CARAPACE);
                }
                if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 450)
                {
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Blade Ward", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_BLADE_WARD);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Blood Draining", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_BLOOD_DRAINING);
                }

                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Accuracy -- 25 Hit + 25 Crit", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_ACCURACY);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Black Magic -- 250 Spell Haste Proc", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_BLACK_MAGIC);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Battlemaster -- Chance of heal on hit", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_BATTLEMASTER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Berserking -- 400 Attack Power Proc", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_BERSERKING);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Exceptional Agility -- 26 Agility", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_AGILITY_1H);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Exceptional Spirit -- 45 Spirit", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_SPIRIT);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Executioner -- 120 Arm Pen Proc", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_EXECUTIONER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Icebreaker -- Fire damage on hit", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_ICEBREAKER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Lifeward -- Chance of heal on hit", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_LIFEWARD);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Mighty Spellpower -- 63 Spell Power", GOSSIP_SENDER_MAIN,
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Superior Potency -- 65 Attack Power", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_POTENCY);
            ...
            void Show2HWeaponMenu(Player* player, Creature* creature)
            {
                ...
                if (player->getClass() == CLASS_DEATH_KNIGHT)
                {
                    ...
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Razorice", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_RAZORICE);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Spellshattering", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_SPELLSHATTERING);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Swordshattering", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_SWORDSHATTERING);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Fallen Crusader", GOSSIP_SENDER_MAIN,
                        ENCHANT_WEP_FALLEN_CRUSADER);
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Stoneskin Gargoyle", GOSSIP_SENDER_MAIN,
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Executioner -- 120 Arm Pen Proc", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_EXECUTIONER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Spellpower -- 81 Spell Power", GOSSIP_SENDER_MAIN,
                    ENCHANT_WEP_GREATER_SPELL_POWER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Agility -- 35 Agility", GOSSIP_SENDER_MAIN,
            ...
            void ShowShieldMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Stamina -- 18 Stamina", GOSSIP_SENDER_MAIN,
                    ENCHANT_SHIELD_MAJOR_STAMINA);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Resilience -- 12 Resilience", GOSSIP_SENDER_MAIN,
            ...
            void ShowHeadMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Arcanum of Dominance -- 30 Spell Power + 20 Crit", GOSSIP_SENDER_MAIN,
            ...
            void ShowShouldersMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Axe -- 40 Attack Power + 15 Crit", GOSSIP_SENDER_MAIN,
                    ENCHANT_SHOULDER_GREATER_AXE);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Crag -- 24 Spell Power + 8 Mp5", GOSSIP_SENDER_MAIN,
                    ENCHANT_SHOULDER_GREATER_CRAG);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Pinnacle -- 30 Stamina + 15 Resil", GOSSIP_SENDER_MAIN,
            ...
            void ShowCloakMenu(Player* player, Creature* creature)
            {
                ...
                if (player->getClass() == CLASS_ROGUE)
                    AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Shadow Armor", GOSSIP_SENDER_MAIN,
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Wisdom -- 10 Spirit +2% reduce threat", GOSSIP_SENDER_MAIN,
                    ENCHANT_CLOAK_WISDOM);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Titanweave -- 16 Defense", GOSSIP_SENDER_MAIN,
                    ENCHANT_CLOAK_TITANWEAVE);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Spell Piercing -- 35 Spell Pen", GOSSIP_SENDER_MAIN,
            ...
            void ShowChestMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Exceptional Resilience -- 20 Resilience", GOSSIP_SENDER_MAIN,
            ...
            void ShowBracerMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Spirit -- 18 Spirit", GOSSIP_SENDER_MAIN,
                    ENCHANT_BRACER_MAJOR_SPIRIT);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Expertise -- 15 Expertise", GOSSIP_SENDER_MAIN,
                    ENCHANT_BRACER_EXPERTISE);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Stats -- 6 all stats", GOSSIP_SENDER_MAIN,
                    ENCHANT_BRACER_GREATER_STATS);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Superior Spellpower -- 30 Spell Power", GOSSIP_SENDER_MAIN,
                    ENCHANT_BRACER_SUPERIOR_SPELLPOWER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Stamina -- 40 Stamina", GOSSIP_SENDER_MAIN,
            ...
            void ShowGlovesMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Assault -- 44 Attack Power", GOSSIP_SENDER_MAIN,
                    ENCHANT_GLOVES_CRUSHER);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Agility -- 20 Agility", GOSSIP_SENDER_MAIN,
                    ENCHANT_GLOVES_MAJOR_AGILITY);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Precision -- 20 Hit Rating", GOSSIP_SENDER_MAIN,
            ...
            void ShowLegsMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Earthen Leg Armor -- 40 Resil 28 Stam", GOSSIP_SENDER_MAIN,
            ...
            void ShowBootsMenu(Player* player, Creature* creature)
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Fortitude -- 22 Stamins", GOSSIP_SENDER_MAIN,
                    ENCHANT_BOOTS_GREATER_FORTITUDE);
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Spirit -- 18 Spirit", GOSSIP_SENDER_MAIN,
