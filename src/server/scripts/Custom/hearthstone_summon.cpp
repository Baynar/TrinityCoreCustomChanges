...
{
    public:
        ItemUse_item_custom_summon() : ItemScript("item_custom_summon") {}
	...
	bool OnUse(Player* pPlayer, Item* pItem, const SpellCastTargets &pTargets)
	{
	    ...
	    // TeleNPC
          pPlayer->SummonCreature(190000,pPlayer->GetPositionX()+4 ,pPlayer->GetPositionY(), pPlayer->GetPositionZ(), 0,TEMPSUMMON_TIMED_DESPAWN,20000);
	    //}
            return false;
	    }
